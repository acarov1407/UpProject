...
function Sidebar() {
  ...
  return (
    <aside className={`${isActiveResponsiveBar ? 'left-0' : 'left-[-100%]'} md:block md:w-72 lg:w-80 px-8 py-10 bg-gray-900 fixed top-0 w-full h-full duration-500 md:relative md:h-auto md:left-0 z-5`}>
