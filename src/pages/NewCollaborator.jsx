...
function NewCollaborator() {
    ...
    return (
        <>
            <h1 className="text-4xl font-black text-white text-center leading-normal">Añadir Colaborador(a) al proyecto: <span className="block">{currentProject.name}</span> </h1>
                    ...
                    (
                        <div className="flex justify-center mt-10">
                            <div className="bg-gray-900 px-5 py-7 rounded-md shadow border border-gray-600 w-full max-w-md">
                                <h2 className="text-center mb-10 text-xl font-bold text-white">Resultado:</h2>
